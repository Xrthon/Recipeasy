...
import { generate12HourCycleNumbers, generate12HourNumbers, generateAmPmItems, generateNumbers } from "../../utils/generateNumbers";
...
const DurationScroll = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const getNearestInRangeValue = useCallback(value => getValidValue ? getValidValue(value) : getNearestInRange(value, adjustedLimited.min, adjustedLimited.max), [adjustedLimited, getValidValue]);
