...
exports.generateNumbers = exports.generateAmPmItems = exports.generate12HourNumbers = exports.generate12HourCycleNumbers = void 0;
...
const generate12HourCycleNumbers = options => {
  let numbers = [];
  for (let i = 0; i < 12; i += options.interval) {
    const hour = i === 0 ? 12 : i;
    numbers.push((0, _padNumber.padNumber)(hour, {
 ...
 * // Returns: ['', 'AM', 'PM', '']
 */
exports.generate12HourCycleNumbers = generate12HourCycleNumbers;
const generateAmPmItems = options => {
  const padding = Array(options.padWithNItems).fill("");
  return [...padding, options.amLabel, options.pmLabel, ...padding];
};
exports.generateAmPmItems = generateAmPmItems;
