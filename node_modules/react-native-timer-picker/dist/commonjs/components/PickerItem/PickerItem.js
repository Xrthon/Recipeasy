...
const PickerItem = /*#__PURE__*/_react.default.memo(({
  ...
  if (isAmPmPicker) {
    ...
    isDisabled = !(0, _isWithinLimit.isWithinLimit)(intItem, adjustedLimitedMin, adjustedLimitedMax);
  }
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    style: [styles.pickerItem, isSelected && styles.selectedPickerItem, isDisabled ? styles.disabledPickerItem : {}, isAmPmPicker && styles.separateAmPmItem, isAmPmPicker && isSelected && styles.selectedSeparateAmPmItem]
  }, stringItem), is12HourPicker && !separateAmPmPicker && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
