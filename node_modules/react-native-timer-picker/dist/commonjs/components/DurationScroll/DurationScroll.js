...
var _getNearestInRange = require("../../utils/getNearestInRange");
...
const DurationScroll = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const numbersForFlatList = (0, _react.useMemo)(() => {
    if (isAmPmPicker) {
      return (0, _generateNumbers.generateAmPmItems)({
        amLabel: amLabel ?? "am",
        padWithNItems,
        pmLabel: pmLabel ?? "pm"
      });
    ...
    if (is12HourPicker) {
      ...
      if (separateAmPmPicker) {
        return (0, _generateNumbers.generate12HourCycleNumbers)({
  ...
  }, [amLabel, disableInfiniteScroll, is12HourPicker, isAmPmPicker, interval, numberOfItems, padNumbersWithZero, padWithNItems, pmLabel, safeRepeatNumbersNTimes, separateAmPmPicker]);
  ...
  const renderItem = (0, _react.useCallback)(({
    ...
    styles: styles
  }), [adjustedLimited.max, adjustedLimited.min, allowFontScaling, amLabel, is12HourPicker, isAmPmPicker, isItemDisabled, labelPositionStyle, pmLabel, selectedValue, separateAmPmPicker, styles]);
  const getNearestInRangeValue = (0, _react.useCallback)(value => getValidValue ? getValidValue(value) : (0, _getNearestInRange.getNearestInRange)(value, adjustedLimited.min, adjustedLimited.max), [adjustedLimited, getValidValue]);
